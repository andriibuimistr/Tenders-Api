...
classification_dk021 = [{"33600000-6": "Фармацевтична продукція"},
...
additional_class_scheme = ['ДК003', 'ДК015', 'ДК018', 'specialNorms']

additional_class_003 = [{1: "Законодавці, вищі державні службовці, керівники, менеджери (управителі)"},
                        {2: "Професіонали"},
                        {3: "Фахівці"},
...
additional_class_015 = [{"I": "ДОСЛІДЖЕННЯ ТА РОЗРОБКИ В ГАЛУЗІ ПРИРОДНИЧИХ І ТЕХНІЧНИХ НАУК"},
                        {"II": "ДОСЛІДЖЕННЯ ТА РОЗРОБКИ В ГАЛУЗІ ГУМАНІТАРНИХ І СУСПІЛЬНИХ НАУК"}
                        ]

additional_class_018 = [{"1": "Будівлі"},
                        {"2": "Інженерні споруди"}
                        ]

additional_class_INN = [{"acetylsalicylic acid, combinations excl. psycholeptics": "Acetylsalicylic acid, combinations excl. psycholeptics"},
                        {"aciclovir": "Aciclovir"},
                        {"abiraterone": "Abiraterone"},
                        {"acetylcysteine": "Acetylcysteine"},
                        {"adapalene": "Adapalene"},
                        {"adalimumab": "Adalimumab"},
                        {"aciclovir, combinations": "Aciclovir, combinations"},
