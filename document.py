...
'''# upload document for lot
def upload_documents_to_lot(t_id_long, t_token, related_lot):
    s = requests.Session()
...
# patch document of lot
def patch_document_of_lot(type_for_doc, name_for_doc, added_tender_doc, t_id_long, doc_id, t_token, related_lot):
    s = requests.Session()
    s.request("GET", "{}/api/{}/tenders".format(doc_host, doc_api_version))
    ...
    patch_bid_json['data']['relatedItem'] = related_lot
